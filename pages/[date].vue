<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div v-if="isValidDate" class="bg-gray-100 border border-gray-300 rounded p-4 mb-6">
      ...
      <p class="mb-2">Copy the URL of this page and import it directly into Medium using the URL import option.</p>
      <p>Generated by <a
          href="https://medium-backdate.williamchong.cloud" target="_blank"
