  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="max-w-2xl mb-8">
      ...
      <div class="mb-6">
        ...
        <input id="backdateInput" v-model="selectedDate" type="date" class="border rounded px-3 py-2 w-full max-w-xs"
      ...
      <ol class="list-decimal pl-6 mb-6 space-y-2">
        ...
        <li>
          <figure>
            ...
            <img src="~/assets/import-page.png" alt="Medium Import Page" class="w-full">
          </figure>
        </li>
        <li>
          <figure>
            ...
            <img src="~/assets/import-result.png" alt="Import Result" class="w-full">
          </figure>
        </li>
      </ol>
